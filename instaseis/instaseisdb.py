...
class InstaseisDB(object):
    ...
    def __str__(self):
        ...
        return_str = (
            ...
            reciprocal="reciprocal" if self.is_reciprocal else "forward",
            components=components,
            source_depth=(
                "\tsource depth         : %.2f km\n" %
            ...
            min_radius=self.parsed_mesh.kwf_rmin,
            max_radius=self.parsed_mesh.kwf_rmax,
            planet_radius=self.parsed_mesh.planet_radius / 1E3,
            ...
            compiler=self.parsed_mesh.axisem_compiler,
            user=self.parsed_mesh.axisem_user,
            format_version=self.parsed_mesh.file_version,
            axisem_version=self.parsed_mesh.axisem_version,
            datetime=self.parsed_mesh.creation_time
        )
        return return_str
