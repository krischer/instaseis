...
class AxiSEMDB(object):
    """
    A class to extract Seismograms from a set of wavefields generated by AxiSEM.
    Taking advantage of reciprocity of the Green's function, two simulations
    with single force sources (vertical and horizontal) to build a complete
    Database of Green's function in global 1D models. The spatial discretization
